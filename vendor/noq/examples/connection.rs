//! This example intends to use the smallest amount of code to make a simple
//! QUIC connection.
//!
...
async fn main() -> Result<(), Box<dyn Error + Send + Sync + 'static>> {
    ...
    tokio::spawn(async move {
        ...
        // Dropping all handles associated with a connection implicitly closes
        // it
    });
    ...
    // Waiting for a stream will complete with an error when the server closes the
    // connection
