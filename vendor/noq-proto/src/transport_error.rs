...
use crate::VarInt;
use crate::coding::{self, BufExt, BufMutExt, Decodable, Encodable};
use crate::frame::MaybeFrame;

/// Transport-level errors occur when a peer violates the protocol specification
///
/// # Note
///
/// The `PartialEq` implementation for this type performs comparison on the
/// `code` field only
#[derive(Debug, Clone)]
#[non_exhaustive]
pub struct Error {
