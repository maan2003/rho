...
///
/// The problem is the 12-byte nonce in AES-GCM: I suspect the original authors
/// of this code didn't like the fact that it limits you to ~2^32 safe
/// encryptions before you're getting into "dangerous" nonce-reuse territory
/// with randomly-generated nonces. You can't use sequence numbers either,
/// though, because that doesn't look random to clients and leaks information.
