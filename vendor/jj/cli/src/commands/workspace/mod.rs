...
use self::managed::ManagedWorkspaceCommand;
use self::managed::cmd_managed_workspace;
...
pub(crate) enum WorkspaceCommand {
    ...
    /// Manage jj-allocated, repository-local workspaces
    #[command(subcommand)]
    Managed(ManagedWorkspaceCommand),
...
pub(crate) async fn cmd_workspace(
    ...
    match subcommand {
        ...
        WorkspaceCommand::Managed(args) => cmd_managed_workspace(ui, command, args).await,
