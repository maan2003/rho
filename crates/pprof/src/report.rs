...
use crate::temporal::{TemporalArchive, TemporalReport};
...
impl<'a> ReportBuilder<'a> {
    ...
    /// Build the timestamped sample report.
    pub fn build_temporal(&self) -> TemporalReport {
        crate::profiler::drain_temporal(&self.temporal_archive);
